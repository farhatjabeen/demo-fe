...
export default function HeaderDropdown({ isBusiness, navigateOne, titleOne, navigateTwo, titleTwo, handleLogout }) {
    ...
    return (
        <Menu as="div" className="relative text-left">
            ...
            >
                <Menu.Items className={` absolute top-14 left-4 z-10 mt-2 xl:w-56 md:w-44 sm:w-28 rounded-md bg-white shadow-lg border border-solid border-[#B6B6B6] `}>
