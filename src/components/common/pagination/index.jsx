...
const Pagination = ({ isBlueBackground, currentPage = 1, totalPages = 0, onPageChange }) => {
  ...
  const renderPageButton = (pageNumber) => (
    <a
      href="#"
      key={pageNumber}
      className={`relative inline-flex items-center px-4 py-2 rounded-md text-black focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue mr-1 
  ...
  const renderDots = () => (
    <span className="relative inline-flex items-center px-2 py-2 text-gray-400 ">...</span>
  )
  return (
