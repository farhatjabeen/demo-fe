...
function TextInput({ type = 'text', onChange, placeholder, name, disable, errorClass, isSearchReport = false,
    eyeClass, className: inputClassName, showPassword, setShowPassword }) {
                            ...
                            render={({
                                ...
                                <div className={` flex ${type === 'password' && 'relative'}`}>
                                    <div className="relative w-full">
                                        ...
                                        {type === 'password'
                                            &&
                                            <div className={eyeClass} onClick={() => setShowPassword(!showPassword)}>
                                                {showPassword ?
