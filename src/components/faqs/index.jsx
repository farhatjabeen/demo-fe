    ...
    return (
        <div className=' bg-white mb-32'>
            ...
            <div className='relative flex justify-start xl:flex-row md:flex-col md:items-center w-full sm:flex-col sm:items-center mt-10'>
                ...
                <div className='ml-20 mt-4 xl:w-1/2 md:w-2/3 xl:end-1/3 xl:mr-40 md:flex md:flex-col sm:w-full sm:flex sm:flex-col'>
                ...
                <div className='xl:absolute xl:top-4 xl:right-20 xl:w-1/3 md:w-full xl:h-96 md:h-11/12 md:flex md:justify-center'>
                    <img className='bg-[#00B7D0] xl:h-96 xl:w-full md:h-11/12 md:w-3/5 ' src={faqImage} alt='faqImage' />
                </div>
            </div>
        </div>
    )
