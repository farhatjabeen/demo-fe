...
export default function Faq({ questions }) {
    ...
    return (
        <div className=' bg-white mb-32'>
            ...
            <div className='flex xl:flex-row md:flex-col md:items-center w-full sm:flex-col sm:items-center justify-center mt-10'>

                <div className='absolute mt-2 xl:w-1/2 xl:end-1/3 xl:mr-40 md:flex md:flex-col sm:w-full sm:flex sm:flex-col'>
                ...
                <div className='xl:ml-96 xl:w-1/3 bg-green xl:h-96 md:h-11/12 '>
                    <img className='bg-[#00B7D0] xl:h-96 xl:w-full md:h-11/12 md:w-11/12 ' src={faqImage} alt='faqImage' />
                </div>
            </div>
        </div>
    )
