    ...
    <div>
      <div className="bg-primary-color flex flex-col justify-center items-center p-10 pb-5">
        <div className="p-6 flex flex-col justify-space items-center h-full">
          ...
          <div>
            <ul
              className="footer-links flex p-3 sm:flex-col md:flex-row 
          ...
          <div
            className={`flex justify-center py-5 ${userDetails?.role === 'BUSINESS' ? 'hidden' : ''}`}
          >
            <button
      ...
      <div className="copy-rights w-full py-2">
        <p className="text-white text-center font-bold">
          Copyright &#169; 2023 ILost Serbia. All Rights Reserved.
        </p>
      </div>
    </div>
  )
