...
export default function SearchCards(props) {
    ...
    return (
        <div className='mt-44 h-96 flex flex-col items-center relative'>

            <div className='h-full'>
                <img src={`${props.imageName[0]}`} className='rounded-2xl xl:h-60 xl:w-96 md:h-48 md:w-56 sm:h-44 sm:w-52' alt='keys' />
            </div>
            <div className='absolute bg-white xl:w-96 xl:h-60 md:h-48 md:w-56 sm:h-44 sm:w-52 border border-[#D8FFFF] xl:top-52 md:top-40 sm:top-36 rounded-2xl flex justify-center items-center'>
