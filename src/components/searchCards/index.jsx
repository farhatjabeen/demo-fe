        ...
        <div className='mt-16 h-96 flex flex-col items-center relative'>
            ...
            <div className='h-full'>
                {props.imageName[0]?.length ?
                    <img src={props.imageName[0]} className='rounded-2xl xl:h-60 xl:w-80 md:h-48 md:w-56 sm:h-44 sm:w-52'
                        alt='keys' />
                    :
                    <div className='flex justify-center items-center bg-white rounded-2xl xl:h-60 xl:w-80 md:h-48 md:w-56 
                    sm:h-44 sm:w-52 border border-solid border-white-grey'>
                        <p>No Image</p>
                    </div>
                }
            </div>
            <div className='absolute bg-white xl:w-80 xl:h-60 md:h-48 md:w-56 sm:h-44 sm:w-52 border border-baby-blue 
            xl:top-52 md:top-40 sm:top-36 rounded-2xl flex justify-center items-center'>
                <div className='xl:h-44 xl:w-60 md:w-48 md:h-40 sm:w-44 sm:h-36  xl:mt-5' key={props.idx}>
                    ...
                    <div className='flex justify-between'>
                        <div >
                            <button onClick={() => navigate(`/claimItem/${props.itemId}`)}
                        ...
                        <div className='cursor-pointer xl:mt-8 md:mt-6 sm:mt-2 flex justify-center items-center text-sm 
                        font-normal' >
