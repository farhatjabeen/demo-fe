      ...
      <div className="xl:my-20 flex xl:items-start md:flex-col sm:flex-col items-center">
        <div className="flex sm:items-center p-2 bg-white border-solid xl:rounded-2xl xl:h-1/5 xl:w-fit md:rounded-3xl md:h-14 md:w-80 sm:h-12 sm:rounded-2xl sm:w-64 border border-greys border-opacity-50">
          <button
            ...
            className="cursor-pointer xl:h-14 xl:w-64 xl:rounded-xl md:w-52 md:h-10 md:rounded-2xl md:text-md xl:text-xl sm:rounded-xl sm:text-sm sm:h-9 sm:w-44 font-normal"
            style={{
              backgroundColor: buttonActive ? '#266867' : 'white',
          ...
          <button
            ...
            className="cursor-pointer xl:h-14 xl:w-64 xl:rounded-xl md:w-52 md:h-10 md:rounded-2xl md:text-md xl:text-xl sm:rounded-xl sm:text-sm sm:h-9 sm:w-44 font-normal"
            style={{
              backgroundColor: buttonActive ? 'white' : '#266867',
              color: buttonActive ? 'black' : 'white',
            }}
          >
            Report found item
          </button>
        ...
        {buttonActive ? (
          <div
            className="flex items-center mt-6 xl:h-fit xl:py-2 xl:w-xl xl:rounded-3xl md:h-16 md:w-xl 
