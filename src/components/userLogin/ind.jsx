...
export default function UserLoginTwo({ isOpen, onClose,props }) {
        ...
        <div>
            <Popover>
                {({ open }) => (
                    <div>
                        <Popover.Button>
                            <span className="xl:w-64 xl:h-14 xl:text-2xl md:w-52 md:h-14 md:text-lg sm:w-36 sm:h-12 sm:text-sm font-bold bg-primary-color text-white rounded-full xl:mx-1">{props.title}</span>
                        </Popover.Button>
                        <Transition
                            as={Fragment}
