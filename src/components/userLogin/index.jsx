              ...
              {checkUser ?
                ...
                <div>
                  <div>
                    ...
                    <input type='password' value={reEnterPasswordContainer} className='w-full rounded-lg h-12 p-4 font-medium text-base bg-[#E8EDF1]' onChange={(e) => setReEnterPasswordContainer(e.target.value)} />
                  </div>
                  <div>
                    {
                      errorMessage ?
