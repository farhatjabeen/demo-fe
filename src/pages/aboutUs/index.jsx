        ...
        <div>
                ...
                <div className=' bg-primary-colorback h-40 flex justify-center'>
                    <div className='absolute top-32 left-96  mt-96 bg-white p-10 w-7/12 rounded-lg'>
                        ...
                        <div className='text-xl font-medium text-light-black'>
                            <p>
                                Our mission at Ilost is simple: to simplify the process of recovering lost items and bring<br />
                                people together through a shared commitment to helping one another. We believe in the<br />
                                power of technology to connect people and make a positive impact on their lives. By<br />
                                harnessing the latest advancements, we aim to be the go-to platform for lost and found<br />
            ...
            <div className='text-center'>
                ...
                <p className='text-2xl font-medium px-20 pt-6 pb-32 '>
                    ...
                    <br></br>the sensitivity of personal belongings, and our platform is designed with your security in mind.
                    <br></br> We leverage cutting-edge technology to streamline the process of reporting and recovering lost
