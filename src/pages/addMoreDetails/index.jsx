    ...
    return (
        <div className='flex flex-col items-center'>
            ...
            <div className='xl:w-9/12 md:w-10/12 sm:w-11/12 xl:ml-16 mb-10'>
                ...
                <div className='border-b border-b-[#949494] mb-10'>
                    ...
                    <div className='flex justify-between h-12 mb-9 relative'>
                        ...
                        <button className='w-2/4 h-14 sm:h-12 rounded-lg bg-[#E8B810]'>Upload Image</button>
            ...
            <div className='xl:w-7/12 md:w-2/5 sm:w-80 flex justify-between mb-10'>
                    ...
                    <div><button className='xl:w-44 xl:h-14 md:w-40 md:h-14 sm:w-36 sm:h-12 border border-[#B6B6B6] bg-[#E8B810] rounded-lg text-lg cursor-grab' onClick={handleSubmit}>Submit form</button></div>
                </div>
        </div>
    )
}