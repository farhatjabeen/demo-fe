        ...
        <div className='flex flex-col justify-center'>
            <div className='flex flex-col items-center mt-10 mb-20'>
                ...
                <div>
                    ...
                    <button className='w-48 h-14 rounded-lg bg-[#FF9900] ml-5 ' onClick={() => navigate('/businessignup')}>Sign Up</button>
                </div>
            </div>
                ...
                <div className='flex justify-between py-16 w-3/4'>
                    {
                        cardValues.map((items, i) => {
                            return (
                                <div key={i} className='w-80 bg-white border border-[#DDDDDD]'>
