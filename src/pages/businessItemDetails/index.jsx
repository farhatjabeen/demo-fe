...
export default function BusinessItemDetails() {
    ...
    const itemTitles = [{ query: "Item name", answer: itemDetails.itemName },
                ...
                <>
                    ...
                    <div className='my-20 w-full flex justify-center'>
                        <div className='bg-white rounded-lg mx-16 bg-green xl:w-full md:w-96 sm:w-72 p-5 '>
                            <div className='xl:text-3xl md:text-xl sm:text-lg text-primary-color w-full xl:pt-5 md:pt-3 
                            ...
                            {itemTitles.map((items, i) => {
                                return (
                                    <div key={i} className='flex justify-start'>
                                        ...
                                        <div
                                            className={userDetails?.role === 'BUSINESS' ?
