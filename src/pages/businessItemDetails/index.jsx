                    ...
                    {itemTitles.map((items, i) => {
                        return (
                            <div key={i} className='flex justify-start'>
                                <div className='xl:w-52 md:w-60 sm:w-56 text-light-black xl:text-xl md:text-lg sm:text-xs py-1 font-bold'>{items.query}</div>
                                <div className={userDetails?.role === 'BUSINESS' ? 'xl:w-72 md:w-60 sm:w-56 text-left xl:text-xl md:text-base sm:text-xs font-bold py-1' : 'xl:w-full text-left xl:text-xl md:text-base sm:text-xs font-bold py-1'}>{items.answer}</div>
                            </div>
                        );
                    })}
                </div>
