                                ...
                                <div className="mb-2 w-full">
                                        ...
                                        {isUploaded ?
                                            methods.getValues().companylogo || companyLogo ?
                                                <div className='flex flex-wrap w-96'>
                                                    <div className='flex w-fit p-2 bg-white rounded-lg border 
                                    ...
                                    <div >
                                        <div className="flex items-center h-5">
                                            ...
                                            <p className='ml-2 text-xs'>I agree to the
                                                <button class="underline decoration-1 text-oranges"
                                                    onClick={handleTerms}>
