  ...
  return (
    <div>
        ...
        <div className="mt-10 px-16 w-full flex justify-center items-center">
          <div>
            {productDetails?.itemImage && productDetails.itemImage[0] ? (
              <img
                src={productDetails?.itemImage[0]}
                alt="keys"
                className="rounded-3xl xl:h-72 xl:w-96 md:h-60 md:w-64 sm:h-48 sm:w-48"
              ></img>
            ) : (
              <div
                className="flex justify-center items-center bg-white rounded-3xl xl:h-72 xl:w-96 
          ...
          <div
            className="bg-white xl:w-4/5 xl:h-72 md:w-9/12 md:h-60 sm:w-11/12 sm:h-48 rounded-3xl xl:p-8 
      ...
      <div className="flex justify-center items-center mt-10 mb-16">
        <div
          className="bg-white rounded-3xl xl:h-48 xl:w-96 md:h-44 md:w-80 sm:h-40 sm:w-60 shadow-lg 
                flex flex-col items-center justify-center"
        >
          <div className="xl:mb-5 md:mb-5 sm:mb-4">
            <FaPhoneAlt
              className="xl:h-10 xl:w-10 md:h-9 md:w-9 sm:h-7 sm:w-7"
              style={{ color: '#E3A903' }}
            />
          </div>
        ...
        <div
          className="bg-white rounded-3xl xl:h-48 xl:w-96 md:h-44 md:w-80 sm:h-40 sm:w-60 ml-14 
                shadow-lg flex flex-col items-center justify-center"
        >
          <div className="xl:mb-5 md:mb-5 sm:mb-4">
            <HiMail
              className="xl:h-10 xl:w-10 md:h-9 md:w-9 sm:h-8 sm:w-8 "
              style={{ color: '#E3A903' }}
            />
          </div>
