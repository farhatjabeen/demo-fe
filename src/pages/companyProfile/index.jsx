    ...
    <div className='flex flex-col justify-center items-center'>
            ...
            {editButton ?
                <div className='xl:w-3/12 md:w-5/12 sm:w-6/12 flex justify-between mb-10'>
                    ...
                    <div>
                        <button disabled={allowSubmit} onClick={handleSubmit} className='xl:w-44 md:w-44 sm:w-36 xl:h-14 md:h-14 sm:h-12 border border-[solid] border-primary-color bg-primary-color rounded-xl xl:text-lg md:text-lg sm:text-base cursor-grab'>
                            Save Changes
                        </button>
                    </div>
                </div>
