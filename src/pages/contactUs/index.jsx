...
export default function ContactUs() {
    ...
    return (
        <div className='flex flex-col justify-center items-center'>
            ...
            <div className='sm:h-96 md:h-60 xl:h-64 sm:w-2/3 md:w-5/6 xl:w-3/5 rounded-3xl bg-white flex flex-col items-center 
            justify-center '>
                ...
                <div className='sm:h-56 xl:h-28 xl:w-11/12 sm:mt-0 md:mt-0 xl:mt-8 flex md:flex-row sm:flex-col sm:items-center'>
                    <div className='sm:h-32 sm:w-80 md:w-80 xl:w-11/12 rounded-2xl flex flex-col justify-center items-center 
                    bg-White Smoke'>
                        <div className='flex justify-between'>
                            <div className='w-8 flex items-center'>
                                <FaPhoneAlt style={{ color: "#00b8b8", height: '23.95px', width: '23.95px' }} />
                            </div>
                    ...
                    <div className='sm:h-32 sm:w-80 md:w-80 xl:w-11/12 sm:ml-0 md:mt-0 md:ml-5 sm:mt-0 xl:ml-7 h-28 rounded-2xl 
                    flex flex-col justify-center items-center bg-White Smoke'>
                        <div className='flex justify-between'>
                            <div className='w-8 flex items-center'>
                                <FaEnvelope style={{ color: "#00b8b8", height: '23.95px', width: '23.95px' }} />
                            </div>
            ...
            <div className='xl:w-11/12 bg-inherit sm:w-full sm:flex-col sm:justify-center sm:items-center md:flex-row 
                    ...
                    <FormProvider {...methods}>
                        <form onSubmit={methods.handleSubmit(submitData)} className='flex bg-inherit w-full'>
                            <div className='w-full bg-inherit'>
                                <div className='sm:flex sm:justify-center md:justify-start font-semibold text-3xl'>
                                    Get in Touch
                                </div>
                                <div className='sm:w-[500px] bg-inherit mt-7 flex flex-col sm:items-center xl:items-start'>
                                    ...
                                    <div className='flex justify-end w-96'>
                                        <button className='cursor-pointer h-14 w-44 rounded-lg bg-primary-color sm:mb-5'
                                            type="submit">
                                            Submit
                                        </button>
                                    </div>
