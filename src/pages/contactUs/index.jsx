...
export default function ContactUs() {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div
        className="sm:h-96 md:h-60 xl:h-64 sm:w-2/3 md:w-5/6 xl:w-3/5 rounded-3xl bg-white flex flex-col items-center 
            justify-center "
      >
        <div className="sm:mb-10 md:mb-0 md:mt-5 xl:mt-0 font-medium text-2xl">
      ...
      <div
        className="xl:w-11/12 bg-inherit sm:w-full sm:flex-col sm:justify-center sm:items-center md:flex-row 
            flex justify-between mt-16"
      >
        <div className="mr-40">
          <img className="xl:h-[500px] xl:w-[500px]" src={contactUsImage} alt="contactUsImage" />
        </div>
        <div>
