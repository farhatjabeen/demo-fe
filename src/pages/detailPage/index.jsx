...
function DetailPage() {
    return (
        <div className='overflow-hidden'>
            <div>
                <img src={rectangle} alt='...' className='w-full'></img>
            </div>
            <h1 className='text-4xl font-bold py-20 text-center'>
                BTZapp win contract to replace Europe’s largest lost property system
            </h1>
            <div className='xl:flex md:flex sm:block justify-center '>
                <div className='xl:w-7/12 md:6/12 sm:w-full xl:ml-4 sm:ml-2 mr-4'>
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipiscing elit Ut et massa mi.
                        Aliquam in hendrerit urna. Pellentesque sit amet sapien fringilla, mattis ligula consectetur,
                        ultrices mauris. Maecenas vitae mattis tellus. Nullam quis imperdiet augue. Vestibulum auctor ornare leo,
                        ...
                        ultrices mauris. Maecenas vitae mattis tellus. Nullam quis imperdiet augue. Vestibulum auctor ornare leo,
                        non suscipit magna interdum eu. Curabitur pellentesque nibh nibh, at maximus ante fermentum sit amet.
                        Pellentesque commodo lacus at sodales sodales. Lorem ipsum dolor sit amet consectetur adipiscing elit Ut
                        et massa mi. Aliquam in hendrerit urna. Pellentesque sit amet sapien fringilla, mattis ligula consectetur,
                        ultrices mauris. Maecenas vitae mattis tellus. Nullam quis imperdiet augue. Vestibulum auctor ornare leo,
                        non suscipit magna interdum eu. Curabitur pellentesque nibh nibh, at maximus ante fermentum sit amet.
                        Pellentesque commodo lacus at sodales sodales.
                    </p>
                ...
                <div>
                    <img src={transportLondon} className='xl:h-72 xl:w-full md:h-56 md:w-80 sm:h-40 sm:w-60'
                        alt='transportLondon' />
                </div>
            </div>
            <div className='xl:flex md:flex sm:block justify-center pt-12 '>
                <div>
                    <img src={transportLondon} className='xl:h-72 xl:w-full md:h-56 md:w-80 sm:h-40 sm:w-60'
                        alt='transportLondon' />
                </div>
                <div className='xl:w-7/12 md:6/12 sm:w-full xl:ml-4 sm:ml-2'>
                    <p>
                        ...
                        sodales sodales. Lorem ipsum dolor sit amet consectetur adipiscing elit Ut et massa mi.
                        Aliquam in hendrerit urna. Pellentesque sit amet sapien fringilla, mattis ligula consectetur,
                        ultrices mauris. Maecenas vitae mattis tellus. Nullam quis imperdiet augue. Vestibulum auctor ornare leo,
                        non suscipit magna interdum eu. Curabitur pellentesque nibh nibh, at maximus ante fermentum sit amet.
                        Pellentesque commodo lacus at sodales sodales. Lorem ipsum dolor sit amet consectetur adipiscing elit Ut
            ...
            <div className='px-24 py-10'>
                <p>
                    ...
                    sodales. Lorem ipsum dolor sit amet consectetur adipiscing elit Ut et massa mi. Aliquam in hendrerit urna.
