            ...
            <div className="w-full px-24">
                ...
                <div className="flex justify-between h-fit mb-9 relative">
                  ...
                  <div>
                    ...
                    <div className="flex justify-center items-center">
                      <ImageUpload
                        name="itemImage"
                        designClass="xl:w-80 md:w-96 sm:w-64 h-14 sm:h-12 xl:mr-2 rounded-lg bg-primary-color flex items-center justify-center cursor-pointer"
                        multiple={true}
              ...
              <div className="flex flex-col items-center justify-between mt-20">
                <div className="xl:w-4/12 md:w-2/5 sm:w-80 flex justify-between items-center mb-10">
                  <div>
                    <button
                      className="xl:w-44 xl:h-14 md:w-40 md:h-14 sm:w-36 sm:h-12 border 
                                    border-greys bg-white rounded-lg text-lg cursor-pointer"
                      onClick={(e) => {
                        window.history.back()
                        e.preventDefault()
                      }}
