...
const EditFoundItems = () => {
  ...
  const { userName, mobileNumber, emailMailId, foundDate, foundTime, location, itemCategory } =
    foundItemDetails || {}
  useEffect(() => {
    if (foundItemDetails) {
          ...
          items={[
            {
              ...
              className: 'text-black xl:text-4xl sm:text-2xl mt-10',
            },
            {
              label: 'Edit Found Items',
              className: 'text-black font-bold xl:text-4xl sm:text-2xl  mt-10',
            },
          ]}
        />
      </div>
              ...
              <div className="p-4">
                <div className="xl:flex lg:flex md:flex xs:block ">
                  <div className="xl:w-1/3 xs:w-full md:w-1/2 mb-4">
                    ...
                    <p className="w-11/12 py-2 px-3  bg-gray border border-light-gray  rounded-md">
                      {userName}
                    </p>
                  </div>
                ...
                <div className="xl:w-1/3 xs:w-full md:w-1/2">
                  ...
                  <div>
                    <div className="flex">
                      <ImageUpload
                        name="itemImage"
                        designClass="xl:ml-1 xl:w-80 md:w-96 sm:w-80 h-14 sm:h-12 rounded-xl bg-primary-color flex 
                      ...
                      {foundItemDetails?.itemImage || isUploaded ? (
                        <div>
                          <button
                            ...
                            className="h-12 w-11 bg-primary-color ml-2 rounded-xl 
                    ...
                    {isImage ? '' : <p className="ml-1 text-red">Images required</p>}
                  </div>
                </div>
              </div>
            </div>
