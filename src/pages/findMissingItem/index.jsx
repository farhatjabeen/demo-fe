  ...
  return (
    <div className="flex flex-col items-center mt-5">
      ...
      <div className='xl:h-20 xl:w-4/6 md:h-20 md:w-4/5 sm:h-20 sm:w-4/5 rounded-3xl bg-white border border-solid border-[#DDDDDD] flex items-center justify-center'>
        ...
        <button className='xl:w-1/5 sm:w-1/4 h-14 rounded-2xl border border-solid border-[#FFFFFF] text-2xl font-semibold text-white bg-[#E8B810] ml-3.5' onClick={handleSearch}>Search</button>
      </div>
      ...
      <div className='bg-[#FFFAE9] mt-12 xl:h-52 md:h-52 sm:h-44 xl:w-3/4 md:w-3/4 sm:w-11/12 flex flex-col justify-center'>
        ...
        <div className='flex justify-center'><button className='xl:h-11 xl:w-44 md:h-11 md:w-44 sm:h-9 sm:w-36 rounded-lg bg-[#E8B810] mt-4'>Send an Alert</button></div>
      </div>
