    ...
    return (
        <div className='flex flex-col justify-center items-center'>
            <div className='flex justify-center mb-12'>
                ...
                {editButton ? null : <div><button className='w-24 h-10 rounded-xl bg-[#E8B810] border-none text-sm flex justify-center items-center cursor-grab' onClick={handleEditButton}> Edit <FaPenToSquare style={{ marginLeft: "5px" }} /></button> </div>}
            </div>
            ...
            {editButton ?
                <div className='xl:w-3/12 md:w-5/12 sm:w-7/12 flex justify-between mb-10'>
                    ...
                    <div>
                        <button disabled={allowSubmit} onClick={handleSubmit} className='w-44 h-14 border border-[solid] border-[#E8B810] bg-[#E8B810] rounded-xl text-lg cursor-grab'>
                            Save Changes
                        </button>
                    </div>
                </div>
