                    ...
                    <div className='w-full px-24'>
                        ...
                        {editButton ?
                            <div className='w-full flex mb-10 justify-center'>
                                ...
                                <div>
                                    <button onClick={handleEditButton} className='cursor-pointer w-44 h-14 border border-[solid] border-[#B6B6B6] bg-white rounded-xl text-lg cursor-grab'>
                                        Cancel
                                    </button>
                                </div>
                                <div>
                                    <button type='submit' className='cursor-pointer w-44 h-14 ml-5 border border-[solid] border-primary-color bg-primary-color rounded-xl text-lg cursor-grab'>
                                        Save Changes
                                    </button>
                                </div>
                            </div>
