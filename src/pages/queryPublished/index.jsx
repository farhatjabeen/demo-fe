...
export default function QueryPublished() {
  ...
  const handleEditItem = (id) => {
    navigate(`/user/addMoreDetails/${id}`)
  }
    ...
    <div>
      <div>
        ...
        <div className="flex justify-center xl:my-12 sm:mt-12 mx-16">
          ...
          <div
            className="xl:h-72 xl:w-2/3 md:h-60 md:w-8/12 sm:h-48 sm:w-10/12 ml-7 rounded-[24px] 
          ...
          >
            <div className="xl:p-7 md:px-5 md:pt-4 sm:pl-4">
              ...
              <div className="m-2">
                ...
                <div className="w-[250px] mt-2 flex">
                  <div className="flex items-center">
              ...
              <div className="flex justify-between xl:w-80 xl:mt-8 md:w-80 md:mt-7 sm:w-72 sm:mt-5">
                ...
                <div>
                  <button
                    ...
                    className="cursor-pointer xl:h-14 xl:ml-4 
