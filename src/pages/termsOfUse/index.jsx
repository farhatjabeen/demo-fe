    ...
    return (
        <>
            <div className='relative flex justify-center'>
                <button className='cursor-pointer text-2xl absolute left-20 top-2' onClick={() => window.history.back()}>
                    <IoMdArrowBack />
                </button>
            ...
            <div className='px-20 lg:px-40 lg:pt-20 pt-10'>
                <div>
                    ...
                    <p className='text-xl mb-4 text-light-black'>
                        By using the Ilost website, you acknowledge that you have read, understood, and agree to be bound
                        by these Terms of Use. Ilost reserves the right to modify, update, or revise these terms at any time.
                ...
                <div>
                    ...
                    <ul className='text-xl  text-light-black list-disc ml-6 mb-4'>
                        <li>
                            Accessing data not intended for you or logging into a server or account that you are not authorized
                            to access.
                        </li>
                        <li>
                ...
                <div>
                    ...
                    <p className='text-xl mb-4 text-light-black'>
                        ...
                        By using the Service, you consent to the terms of our Privacy Policy.
                    </p>
                </div>
                <div>
                    <h1 className='text-2xl text-primary-color font-bold mb-4'>
                    ...
                    <p className='text-xl mb-4 text-light-black'>
                        All content on the Ilost website, including but not limited to text, graphics, logos, images, and software,
                        is the property of Ilost and is protected by intellectual property laws. You may not modify, reproduce,
                        distribute, or display any part of the Service without the express written consent of Ilost.
                    </p>
                </div>
                <div>
                    <h1 className='text-2xl text-primary-color font-bold mb-4'>
                    ...
                    <p className='text-xl mb-4 text-light-black'>
                        The Service is provided on an "as-is" and "as available" basis. Ilost makes no warranties, expressed or
                ...
                <div>
                    ...
                    <p className='text-xl mb-4 text-light-black'>
                        In no event shall Ilost or its affiliates be liable for any indirect, incidental, special, or consequential
