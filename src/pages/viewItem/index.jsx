...
import { searchDetailsById, searchItemById, searchKey } from '../../redux/reducers/itemsSlice';
                ...
                <div className='mt-10 xl:w-10/12 md:w-11/12 sm:w-11/12 flex justify-center items-center'>
                    ...
                    <div className='bg-white xl:w-8/12 xl:h-72 md:w-9/12 md:h-60 sm:w-11/12 sm:h-48 rounded-3xl xl:p-8 md:p-8 sm:p-6 ml-5 border border-solid border-[#B2B2B2]'>
                        ...
                        <div className='xl:mt-6 md:mt-6 sm:mt-3'>
                            <div className='w-64 flex'><div className='flex items-center'><FaMap style={{ color: "#00b8b8", height: "17px", width: "20px" }} /> </div> <div className='font-semibold xl:text-lg md:text-lg sm:text-base ml-2'>{productDetails.location}</div></div>
